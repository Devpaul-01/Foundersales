...
export default function RegisterPage() {
  ...
  if (verifyEmail) {
    // If there's a pending invite token we can tell the user exactly what
    // will happen after they verify, rather than showing a generic message.
    ...
    return (
      <div className="text-center py-4">
        ...
        <p className="text-sm font-medium text-text-primary mb-4">{verifyEmail}</p>

        {hasPendingInvite ? (
          <p className="text-xs text-text-muted mb-4 px-2">
            After verifying, sign in and you'll be taken straight back to accept your workspace invite.
          </p>
        ) : (
